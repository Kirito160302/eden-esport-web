    ...
    <>
      ...
      <section className="section"><div className="wrap grid-2" style={{ gridTemplateColumns: "1.4fr 1fr", alignItems: "start" }}>
        ...
        <div>
          ...
          <div className="info-block" style={{ marginTop: ".8rem" }}><span className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.4}><circle cx="12" cy="12" r="9" /><path d="M3.6 9h16.8M3.6 15h16.8M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18" /></svg></span><div><h4>Suivez Eden</h4><p><a href="https://x.com/EdenEsport01" target="_blank" rel="noopener noreferrer">X</a> · <a href="https://www.instagram.com/eden_esport/" target="_blank" rel="noopener noreferrer">Instagram</a> · <a href="https://www.twitch.tv/edenesport" target="_blank" rel="noopener noreferrer">Twitch</a> · <a href="https://www.youtube.com/@Eden-Esport" target="_blank" rel="noopener noreferrer">YouTube</a></p></div></div>
